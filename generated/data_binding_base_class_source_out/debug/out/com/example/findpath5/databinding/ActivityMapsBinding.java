...
public final class ActivityMapsBinding implements ViewBinding {
  ...
  private ActivityMapsBinding(@NonNull View rootView, @NonNull Button overlayBtn) {
  ...
  public static ActivityMapsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.overlay_btn;
      Button overlayBtn = ViewBindings.findChildViewById(rootView, id);
      if (overlayBtn == null) {
        break missingId;
      }

      return new ActivityMapsBinding(rootView, overlayBtn);
    }
